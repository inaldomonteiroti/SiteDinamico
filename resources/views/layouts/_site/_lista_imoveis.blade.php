	...
	<div class="col s12 m3">
		<div class="card">
			<div class="card-image">
				<a href="{{ route('site.imovel',[$imovel->id,$imovel->titulo]) }}"><img src="{{ asset($imovel->imagem) }}" alt="{{ $imovel->titulo }}"></a>
			</div>
			...
			<div class="card-action">
				<a href="{{ route('site.imovel',[$imovel->id,$imovel->titulo]) }}">Ver mais..</a>
			</div>
		</div>
	</div>
@endforeach
